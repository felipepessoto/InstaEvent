...
{
    public static Instaeventos.Web.Controllers.AccountController Account = new Instaeventos.Web.Controllers.T4MVC_AccountController();
    public static Instaeventos.Web.Controllers.EventController Event = new Instaeventos.Web.Controllers.T4MVC_EventController();
    public static Instaeventos.Web.Controllers.HomeController Home = new Instaeventos.Web.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static readonly string navbar_fixed_top_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/navbar-fixed-top.min.css") ? Url("navbar-fixed-top.min.css") : Url("navbar-fixed-top.css");
